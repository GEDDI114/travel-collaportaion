  ...
  return (
    ...
    // <></>
        ...
        <div className={TourCardsStyle.Card}>
            <div className={TourCardsStyle.CardImage} style={{backgroundImage:`url(${props.background})`}}>
                <div className={TourCardsStyle.Country} style={{backgroundImage:`url(${props.logo})`}}>

                </div>
            </div>
            <div className={TourCardsStyle.PeoplesAndDays}>
                <div className={TourCardsStyle.DaysAndPeople}>
                    <img src='https://cdn-icons-png.flaticon.com/128/747/747310.png' alt="" width={'23px'} height={'25px'}/>
                    <p>8 days</p>
                </div>
                <div className={TourCardsStyle.DaysAndPeople}>
                    <img src='https://cdn-icons-png.flaticon.com/128/1077/1077063.png' alt="" width={'23px'} height={'25px'}/>
